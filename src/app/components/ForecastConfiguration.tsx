  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white" style={{ fontFamily: 'Inter, sans-serif' }}>
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-24">
        ...
        {/* Back Link */}
        <button onClick={onBack} className="text-slate-400 hover:text-white transition-colors text-sm mb-8 sm:mb-12 inline-block">
          ← Back to work
        </button>

        {/* Project Title */}
        <div className="mb-16 sm:mb-20">
          <div className="text-slate-500 text-sm mb-4">Clari Studio · 2023</div>
        ...
        <section className="mb-16 sm:mb-24">
          ...
          <p className="text-base sm:text-lg text-slate-300 leading-relaxed mb-8 sm:mb-12 max-w-3xl">
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            <div className="bg-white/5 border border-white/10 p-6 rounded-lg">
              <div className="text-3xl text-white mb-2">4–8 hrs/week</div>
              <p className="text-slate-400 text-sm">Spent by consultants on configuration work</p>
            </div>
            <div className="bg-white/5 border border-white/10 p-6 rounded-lg">
              <div className="text-3xl text-white mb-2">1–7 days</div>
              <p className="text-slate-400 text-sm">Average turnaround per request</p>
            </div>
            <div className="bg-white/5 border border-white/10 p-6 rounded-lg">
              <div className="text-3xl text-white mb-2">Growing</div>
              <p className="text-slate-400 text-sm">Month-over-month increase in requests</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-16 sm:mb-24">
          ...
          <ul className="text-base sm:text-lg text-slate-300 leading-relaxed space-y-2 mb-8 sm:mb-12 list-disc list-inside">
        ...
        <section className="mb-16 sm:mb-24">
          ...
          <p className="text-base sm:text-lg text-slate-300 leading-relaxed mb-6 sm:mb-8 max-w-3xl">
          ...
          <div className="space-y-4">
            <div className="bg-white/5 border border-white/10 p-4 sm:p-6 rounded-lg">
              <div className="text-white font-medium mb-1">Phase 1: Read-only visibility</div>
              <p className="text-slate-400 text-sm">Give customers clarity before control</p>
            </div>
            <div className="bg-white/5 border border-white/10 p-4 sm:p-6 rounded-lg">
              <div className="text-white font-medium mb-1">Phase 2: Editing with guardrails</div>
              <p className="text-slate-400 text-sm">Enable safe configuration changes</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-16 sm:mb-24">
          ...
          <div className="bg-white/5 border border-white/10 rounded-lg p-4 sm:p-6 md:p-8 mb-8">
            <h3 className="text-white text-base sm:text-lg mb-4 sm:mb-6">Configuration Request Analysis</h3>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="md:col-span-2 space-y-3">
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-slate-300 text-sm">Change Formulas</span>
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-slate-300 text-sm">Add/Change Fields</span>
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-slate-300 text-sm">Create New Tab(s)</span>
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-slate-300 text-sm">Change Labels</span>
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-slate-300 text-sm">Mass Updates</span>
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-slate-300 text-sm">Remove Fields</span>
                    <span className="text-slate-500 text-sm">3.0%</span>
                  </div>
                  <div className="h-3 bg-white/5 rounded-full overflow-hidden">
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-slate-300 text-sm">Update Existing Models</span>
                    <span className="text-slate-500 text-sm">2.5%</span>
                  </div>
                  <div className="h-3 bg-white/5 rounded-full overflow-hidden">
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-slate-300 text-sm">Create New Models</span>
                    <span className="text-slate-500 text-sm">2.0%</span>
                  </div>
                  <div className="h-3 bg-white/5 rounded-full overflow-hidden">
              ...
              <div className="space-y-4">
                <div className="bg-[#3700ff]/10 border border-[#3700ff]/30 p-4 rounded-lg">
                  ...
                  <div className="text-white text-3xl font-medium">201</div>
                </div>
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  <div className="text-slate-400 text-xs uppercase tracking-wider mb-1">Time Period</div>
                  <div className="text-white text-xl">23 days</div>
                </div>
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  <div className="text-slate-400 text-xs uppercase tracking-wider mb-1">Avg/Day</div>
                  <div className="text-white text-xl">~9 requests</div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 pt-6 border-t border-white/10">
              <h4 className="text-white text-sm font-medium mb-3">Impact on Phase 2 Priorities</h4>
              <div className="grid sm:grid-cols-3 gap-4">
                <div className="bg-[#3700ff]/10 border border-[#3700ff]/30 p-4 rounded-lg">
                  <div className="text-[#7c7cff] text-xs uppercase tracking-wider mb-2">Priority 1</div>
                  <div className="text-white text-sm">Formula Editing</div>
                  <div className="text-slate-400 text-xs mt-1">33% of requests</div>
                </div>
                <div className="bg-[#4d1aff]/10 border border-[#4d1aff]/30 p-4 rounded-lg">
                  ...
                  <div className="text-white text-sm">Field Management</div>
                  <div className="text-slate-400 text-xs mt-1">26% of requests</div>
                </div>
                <div className="bg-[#6633ff]/10 border border-[#6633ff]/30 p-4 rounded-lg">
                  ...
                  <div className="text-white text-sm">Tab Creation</div>
                  <div className="text-slate-400 text-xs mt-1">13% of requests</div>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-6 mb-8">
            <div>
              <h3 className="text-white text-lg mb-4">Workflow design for engineering alignment</h3>
            ...
            <div className="bg-[#3700ff]/10 border border-[#3700ff]/30 rounded-lg p-6 mt-6">
              <h5 className="text-white text-sm font-medium mb-3">Decision: Start simple, then scale complexity</h5>
          ...
          <div className="mt-12 space-y-8">
            <h3 className="text-white text-xl mb-6">Phased rollout: From simple to complex</h3>
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-6 my-8">
              <h4 className="text-white text-sm font-medium mb-3">Next challenge: Bulk editing with guardrails</h4>
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-8 mt-12">
              <h4 className="text-white text-lg mb-6">Usability Testing: Capability vs. Confidence</h4>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white/5 border border-white/10 rounded-lg p-6">
                  <h5 className="text-white text-sm font-medium mb-4">Task Completion</h5>
                  
                  <div className="overflow-x-auto">
                    <table className="w-full text-xs">
                      <thead>
                        <tr className="border-b border-white/10">
                          <th className="text-left text-slate-400 font-normal pb-3 pr-4">Participant</th>
                          <th className="text-left text-slate-400 font-normal pb-3 pr-4">Role</th>
                          <th className="text-center text-slate-400 font-normal pb-3">Completed</th>
                        </tr>
                      </thead>
                ...
                {/* User Quotes */}
                <div>
                  <h5 className="text-white text-sm font-medium mb-3">What we heard</h5>
                  <div className="space-y-3">
                    <div className="bg-white/5 border-l-2 border-slate-500 pl-4 py-3">
                      <p className="text-slate-300 text-sm italic">"I'm not sure what I just changed... can I see a summary?"</p>
                      <p className="text-slate-500 text-xs mt-1">— P2, after editing 3 fields</p>
                    </div>
                    <div className="bg-white/5 border-l-2 border-slate-500 pl-4 py-3">
                      <p className="text-slate-300 text-sm italic">"What if I broke something? Is there an undo?"</p>
                      <p className="text-slate-500 text-xs mt-1">— P4, hovering over publish button</p>
                    </div>
                    <div className="bg-white/5 border-l-2 border-slate-500 pl-4 py-3">
                      <p className="text-slate-300 text-sm italic">"I wish I could review everything before it goes live."</p>
                      <p className="text-slate-500 text-xs mt-1">— P1, requesting feature</p>
                    </div>
                  </div>
                </div>
                ...
                {/* Observed Behaviors */}
                <div>
                  <h5 className="text-white text-sm font-medium mb-3">Observed behaviors</h5>
                  <div className="grid sm:grid-cols-2 gap-3">
                    <div className="bg-white/5 rounded-lg p-4">
                      <div className="text-slate-400 text-xs mb-2">5 of 6 participants</div>
                      <p className="text-slate-300 text-sm">Re-checked changes multiple times before publishing</p>
                    </div>
                    <div className="bg-white/5 rounded-lg p-4">
                      <div className="text-slate-400 text-xs mb-2">All participants</div>
                      <p className="text-slate-300 text-sm">Paused 5-10 seconds before clicking "Publish"</p>
                    </div>
                    <div className="bg-white/5 rounded-lg p-4">
                      <div className="text-slate-400 text-xs mb-2">3 of 6 participants</div>
                      <p className="text-slate-300 text-sm">Verbally expressed anxiety about breaking forecasts</p>
                    </div>
                    <div className="bg-white/5 rounded-lg p-4">
                      <div className="text-slate-400 text-xs mb-2">All participants</div>
                      <p className="text-slate-300 text-sm">Requested a way to preview all changes together</p>
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-8 mt-8">
              <h4 className="text-white text-lg mb-6">From Insight to Solution</h4>
              ...
              <div className="space-y-6">
                ...
                {/* Options Considered */}
                <div>
                  <h5 className="text-white text-sm font-medium mb-3">Solutions considered</h5>
                  <div className="space-y-3">
                    <div className="flex gap-3">
                      <div className="text-slate-500 mt-1">•</div>
                      <div>
                        <div className="text-slate-300 text-sm font-medium">Real-time validation warnings</div>
                        <p className="text-slate-400 text-xs mt-1">Show warnings as users edit, but this added cognitive load during editing</p>
                      </div>
                    </div>
                    <div className="flex gap-3">
                      <div className="text-slate-500 mt-1">•</div>
                      <div>
                        <div className="text-slate-300 text-sm font-medium">Confirmation dialog before publish</div>
                        <p className="text-slate-400 text-xs mt-1">Simple to implement, but didn't address the core issue of change visibility</p>
                      </div>
                    </div>
                    <div className="flex gap-3">
                      <div className="text-[#3700ff] mt-1">✓</div>
                      <div>
                        <div className="text-white text-sm font-medium">Draft mode with review step</div>
                        <p className="text-slate-300 text-xs mt-1">Let users accumulate changes and review them together before committing—giving them both visibility and control</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                {/* Why Draft Mode */}
                <div className="bg-[#3700ff]/10 border border-[#3700ff]/30 rounded-lg p-4">
                  <h5 className="text-white text-sm font-medium mb-2">Why draft mode won</h5>
                  <div className="space-y-2 text-slate-300 text-xs">
                    <div className="flex items-start gap-2">
                      <span className="text-[#7c7cff] mt-0.5">→</span>
        ...
        <section className="mb-24">
          <h2 className="text-2xl sm:text-3xl mb-8 text-white">
            Measurable operational impact
          </h2>
          
          {/* Case Volume Trend Chart */}
          <div className="bg-white/5 border border-white/10 rounded-lg p-8 mb-8">
            <h3 className="text-white text-lg mb-6">Configuration Request Volume Over Time</h3>
          ...
          <div className="grid sm:grid-cols-2 gap-6 mb-12">
            <div className="bg-white/5 border border-white/10 p-8 rounded-lg">
              <div className="text-4xl text-white mb-3">~80%</div>
              <p className="text-slate-300">Reduction in configuration-related support tickets</p>
            </div>
            <div className="bg-white/5 border border-white/10 p-8 rounded-lg">
              <div className="text-4xl text-white mb-3">Faster</div>
              <p className="text-slate-300">Turnaround for common requests</p>
            </div>
          </div>

          <p className="text-slate-300 text-lg leading-relaxed italic border-l-2 border-white/20 pl-6">
